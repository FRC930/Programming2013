...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support" Type="Folder">
			<Item Name="App EXE.ico" Type="Document" URL="../../6 Wheel Robot Dashboard Project/App EXE.ico"/>
			<Item Name="Parse Digital Module.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Parse Digital Module.vi"/>
			<Item Name="Save DB Images.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Save DB Images.vi"/>
			<Item Name="Receive DS Packet.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Receive DS Packet.vi"/>
			<Item Name="Decode Status Byte.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Decode Status Byte.vi"/>
			<Item Name="Draw Simple Skeleton Picture.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Draw Simple Skeleton Picture.vi"/>
			<Item Name="Build Simple Skeleton Data.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Build Simple Skeleton Data.vi"/>
		</Item>
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="DStoPCPacketTypeDef.ctl" Type="VI" URL="../../6 Wheel Robot Dashboard Project/DStoPCPacketTypeDef.ctl"/>
		</Item>
		<Item Name="Dashboard Main.vi" Type="VI" URL="/H/6-Wheel Owen/Dashboard Main.vi"/>
		<Item Name="Dashboard Main.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Dashboard Main.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Get All Users Directory.vi" Type="VI" URL="../../6 Wheel Robot Dashboard Project/Get All Users Directory.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC PC Dashboard" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{F10DA2AE-C6CC-4738-88E2-2B9B484F5EBC}</Property>
